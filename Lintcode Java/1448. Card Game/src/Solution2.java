public class Solution2 {
    ...
    public static void main(String[] args) {
        System.out.println(new Solution2().numOfPlan(2, 3, 5, new int[]{2, 3}, new int[]{2, 2}));
        System.out.println(new Solution2().numOfPlan(3, 5, 10, new int[]{6, 7, 8}, new int[]{2, 3, 5}));
        System.out.println(new Solution2().numOfPlan(5, 3, 9, new int[]{48, 14, 71, 59, 91}, new int[]{1, 1, 0, 2, 2}));
        System.out.println(new Solution2().numOfPlan(54, 6, 19, new int[]{50, 52, 15, 60, 58, 45, 82, 76, 48, 84, 84, 68, 28, 10, 2, 87, 31, 36, 23, 95, 3, 25, 68, 91, 34, 67, 21, 29, 6, 78, 96, 62, 92, 43, 95, 37, 42, 23, 99, 22, 10, 33, 16, 16, 0, 96, 42, 32, 51, 24, 44, 55, 81, 86},
